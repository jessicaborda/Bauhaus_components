	...
	>
		...
		<div>
			...
			>
				...
				<Button variant="outline" color="red" size="medium">
					Medium
				</Button>
				<Button variant="outline" color="red" size="large">
					Large
				</Button>
			</div>
		</div>
		...
		<div>
			...
			>
				<Button variant="text" color="green" size="small">
					Small
				</Button>
				<Button variant="text" color="green" size="medium">
					Medium
				</Button>
				<Button variant="text" color="green" size="large">
					Large
				</Button>
			</div>
		</div>
